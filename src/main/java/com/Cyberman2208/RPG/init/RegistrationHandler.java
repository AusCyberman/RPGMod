...
import com.Cyberman2208.RPG.Reference;
import com.Cyberman2208.RPG.item.SubItems;
...
public class RegistrationHandler
{
    ...
    public static class Blocks
    {
        ...
        {
            RPGMod.getLogger().info("Registering blocks");
    ...
    public static class Items
    {
        ...
        {
            RPGMod.getLogger().info("Registering items");
    ...
    public static class Recipes
    {
        ...
        {
            RPGMod.getLogger().info("Registering recipes");
    ...
    public static class Models
    {
        ...
        {
            RPGMod.getLogger().info("Registering models");
